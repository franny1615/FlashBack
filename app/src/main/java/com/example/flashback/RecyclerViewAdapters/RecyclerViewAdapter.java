...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> implements Filterable {
    ...
    private List<FlashcardEntity> mDataFiltered;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View listItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.swiper, parent, false);
        return new MyViewHolder(listItem);
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        FlashcardEntity flashcard = mDataFiltered.get(position);
        ...
        holder.delete.setOnClickListener(v -> {
            FlashcardEntity cardToDelete = mDataFiltered.remove(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<FlashcardEntity> filteredList = new ArrayList<>();
                    for (FlashcardEntity card : mData) {
                        if (card.getFrontText().toLowerCase().contains(charString.toLowerCase())) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mDataFiltered = (ArrayList<FlashcardEntity>) filterResults.values;
